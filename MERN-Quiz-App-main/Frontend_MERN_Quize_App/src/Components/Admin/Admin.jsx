        ...
        <div className="w-7/12 ">
          ...
          <div className=" ml-32 leading-normal">
            <p className="text-lg text-black-100 leading-loose">
              A Full Stack Web Developer 🚀 from Mathura, India, currently 💻 we are 
              doing our Full Stack Development from GLA University. we are passionate
              about technology and want to learn & explore new technologies. we
